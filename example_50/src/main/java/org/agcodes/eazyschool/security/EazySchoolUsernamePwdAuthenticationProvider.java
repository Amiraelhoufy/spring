...
implements AuthenticationProvider {
  ...
  public Authentication authenticate(Authentication authentication)
    ...
    // don't use password to avoid unnecessary exposing the password to database/ persistence layer
    // readByEmail = findByEmail = getByEmail
    ...
    if(person!= null && person.getPersonId()>0 &&
      ...
      // send null or pwd any ways it is not saved by spring security framework post a successful authentication
    }else{
