...
import org.agcodes.eazyschool.config.EazySchoolProperties;
...
public class ContactService {
  ...
  @Autowired
  private EazySchoolProperties eazySchoolProperties;
...
//    int pageSize = 5;
    ...
    int pageSize = eazySchoolProperties.getPageSize(); // Global Page size

    if(eazySchoolProperties.getContact()!=null && eazySchoolProperties.getContact().get("pageSize")!=null){
      // Specific page size
      pageSize= Integer.parseInt(eazySchoolProperties.getContact().get("pageSize").trim());
