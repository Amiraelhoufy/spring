...
//  @PostMapping("/saveMessage")
  ...
  */
  ...
  public ModelAndView displayMessages(Model model
    ...
    // If current page has no content and it's not the first page, redirect to previous page
    if (contactPages.getContent().isEmpty() && pageNum > 1) {
      return new ModelAndView("redirect:/displayMessages/page/" + (pageNum - 1)
